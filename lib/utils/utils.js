...
class Utils{
     ...
     */
    static timeUntilActivationTimeout() {
     ...
     */
    static setConsoleLogPrefix(prefix) {
        if (!prefix) {
    ...
    static getCommandSizeLimit(){
        return CMD_SIZE_LIMIT;
    }
    static getVarPath(){
        return VAR_PATH;
    }
     ...
     */
    static limitVariableSizes(vars, sizeLimit = CMD_SIZE_LIMIT) {
