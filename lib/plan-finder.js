...
class PlanFinder {
    ...
    async formPlan(source, outputInstructions, currentPlan) {
        ...
        if (currentPlan.length === 1 && currentPlan[0].includes("SenseiTransformer")) {
            ...
            console.log('~~~~~~~~ getting orientation metadata for file', path);
            ...
            if (metadata && metadata.Orientation) {
                console.log("~~~~~~ got metadata", metadata.Orientation);
                ...
                if (orientationTransformer) {
                    ...
                    if (sourceType) {
                        instructions.input.sourceType = sourceType;
                    }
        ...
        console.log("~~~~~~ plan after optionally getting metadata", plan);
