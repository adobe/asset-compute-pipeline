...
class Plan {
    ...
    constructor() {
        ...
        internal.context.state = PLAN_STATE.INITIAL;
    }
    ...
    add(name, attributes={}) {
        ...
        const localCurrent = (internal.groupTail || internal.current)[INTERNAL];
    ...
    advance() {
        ...
        if (this[INTERNAL].context.state === PLAN_STATE.FAILED || this[INTERNAL].context.state === PLAN_STATE.SUCCEEDED) {
