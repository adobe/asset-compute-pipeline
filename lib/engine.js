...
const {GenericError, AssetComputeEvents, AssetComputeMetrics, OpenwhiskActionName, Reason, ClientError, AssetComputeLogUtils, SourceUnsupportedError, RenditionFormatUnsupportedError, RenditionTooLarge, SourceFormatUnsupportedError, SourceUnsupportedError, SourceCorruptError} = require('@adobe/asset-compute-commons');
...
const datauri = require('./sdk/storage/datauri');
