...
class Engine {
    ...
    async executeTransformer(plan) {
        ...
        try {
            ...
            await transformer.compute(transformerContext.input, transformerContext.output);
    ...
    async refinePlan(plan, source, outputInstructions) {
        try {
            ...
            if (!newSteps) {
                ...
                // https://git.corp.adobe.com/nui/core/blob/master/lib/workers.js#L342// internal-repo/nui/core/blob/master/lib/workers.js#L342
