    ...
    async refinePlan(plan, source, outputInstructions) {
        try {
            ...
            if (!newSteps) {
                ...
                // https://git.corp.adobe.com/nui/core/blob/master/lib/workers.js#L342
            ...
            // note: this will replace the core worker selection errors: https://git.corp.adobe.com/nui/core/blob/master/lib/select-workers.js#L43-L65
