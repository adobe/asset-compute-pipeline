...
class Engine {
    ...
    async prepare(transformerContext) {
        ...
        const { firefallClientId, firefallClientSecret, firefallAuthCode, firefallTier, azureOpenAiApiKey } = this[INTERNAL].params;
        if (firefallClientId || firefallClientSecret || firefallAuthCode || firefallTier || azureOpenAiApiKey) {
            transformerContext.input.auth.firefall = { firefallClientId, firefallClientSecret, firefallAuthCode, firefallTier, azureOpenAiApiKey };
        }
    }
