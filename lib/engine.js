...
class Engine {
    ...
    async prepare(transformerContext) {
        ...
        transformerContext.input.auth.fireFall = {
            firefallClientId: this[INTERNAL].params.firefallClientId,
            firefallClientSecret: this[INTERNAL].params.firefallClientSecret,
            firefallAuthCode: this[INTERNAL].params.firefallAuthCode,
            firefallTier: this[INTERNAL].params.firefallTier
        }
    }
