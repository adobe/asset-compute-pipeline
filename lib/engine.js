...
class Engine {
    ...
    async prepare(transformerContext){
        ...
        const transformerDirectory = await Prepare.createDirectories(`${this.stepCount}-${transformer.name}`, this[INTERNAL].baseDirectory);
    ...
    async cleanup(finalOutput) {
        ...
        const cleanupSuccess = await Prepare.cleanupDirectories(this[INTERNAL].transformerDirectories, finalOutputPath);
