...
const {GenericError, AssetComputeEvents, OpenwhiskActionName, Reason, ClientError, AssetComputeLogUtils, RenditionFormatUnsupportedError, RenditionTooLarge, SourceFormatUnsupportedError, SourceUnsupportedError, SourceCorruptError} = require('@adobe/asset-compute-commons');
...
class Engine {
    constructor(params) {
        ...
        this[INTERNAL].context = new EngineContext(this, params);
