...
const {Asset, Rendition, Prepare, Storage, Utils:utils} = require('./sdk');
const {createBaseDirectory, createDirectories, cleanupDirectories} = Prepare;
const {getSource, putRendition} = Storage;
